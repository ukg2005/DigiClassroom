"""
Django settings for digiclassrooms project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-d#1n^_08xs%ku78j=7bmatovw44^l8(uz#%-f!7likjxunk&hx')
...
ROOT_URLCONF = 'digiclassrooms.urls'
...
WSGI_APPLICATION = 'digiclassrooms.wsgi.application'
